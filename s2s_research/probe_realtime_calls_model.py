...
async def test():
    ...
    models = ["gpt-4o-realtime-preview-2024-12-17", "gpt-4o-mini-realtime-preview-2024-12-17", "gpt-realtime-1.5"]
    for m in models:
        url = f"https://api.openai.com/v1/realtime/calls?model={m}"
